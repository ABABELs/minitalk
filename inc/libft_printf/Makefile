...
SOURCES = ft_isalpha.c	ft_isdigit.c	ft_isalnum.c	ft_isascii.c \
		...
		ft_toupper.c	ft_tolower.c	ft_strchr.c		ft_atoi.c \
		ft_memchr.c		ft_memcmp.c		ft_strlcat.c	ft_strncmp.c \
		ft_strnstr.c 	ft_calloc.c		ft_strdup.c		ft_substr.c \
		*ft_strjoin.c	*ft_strtrim.c	ft_strmapi.c	ft_striteri.c \
		ft_putchar_fd.c	ft_putstr_fd.c	ft_putendl_fd.c	ft_putnbr_fd.c \
		ft_itoa.c		**ft_split.c \
		*ft_lstnew.c	ft_lstlast.c	ft_lstsize.c	ft_lstadd_front.c \
		ft_lstadd_back.c	ft_lstdelone.c	ft_lstclear.c	ft_lstiter.c \
		*ft_lstmap.c	ft_printf.c	ft_utility.c	ft_putnbr_hexa.c \
